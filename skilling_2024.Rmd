...
```{r}
data_model=per_fv_2023 %>%
  select(b4q12_perv1,b1q3_perv1,b4q5_perv1,b4q8_perv1,b4q9_perv1,b5pt1q3_perv1,b6q9_perv1,b6q10_perv1)%>%
  mutate(training_type=as.factor(case_when(b4q12_perv1==1~"Formal",
                                 b4q12_perv1 %in% c(1,2,3,4,5)~"Informal",
                                 b4q12_perv1==6~"No Training")),
         total_wages=b6q9_perv1+b6q10_perv1,
         sector=as.factor(case_when(b1q3_perv1==1~Rural,
                                    b1q3_perv1==2~Urban)),
         gender=as.factor(b4q5_perv1),
         general_education=as.factor(case_when(b4q9_perv1!=1~"Technical Education",
...
model=lm(formula = total_wages~training_type+sector+gender+general_education,data_model)
...
```{r}
prop.test(x = 220, n = 13027, conf.level = 0.95, correct = FALSE)
```
